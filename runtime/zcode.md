...
2. 对本 skill 的 4 个 subagent（`requirement-analyst`、`story-breakdown-analyst`、`detailed-design-designer`、`story-map-designer`）：若 `~/.zcode/agents/<name>.md` 不存在，则从来源目录复制过去。
...
| `story-breakdown-analyst` | `["Read","Write","Grep","Glob"]` |
